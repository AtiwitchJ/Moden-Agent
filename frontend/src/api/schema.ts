...
export interface paths {
    ...
    "/api/v1/projects/{projectId}/workboard/dispatch": {
        ...
        get?: never;
        put?: never;
        /** Ask the daemon to retry dispatching Todo cards for a project */
        post: operations["dispatchWorkboard"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/workboard/cards/{cardId}/nudge": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/workboard/cards/{cardId}/retarget": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        /** Retarget a running card's goal and hand off to Hermes or respawn the worker */
        post: operations["retargetWorkCard"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/workboard/cards/{cardId}/split": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        /** Split a running card into a successor card and archive the original */
        post: operations["splitWorkCard"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        ControllersDispatchWorkboardResponse: {
            dispatched: boolean;
            projectId: string;
        };
        ...
        SplitWorkCardRequest: {
            notes: string;
            /** @enum {string} */
            oldCardFate?: "todo" | "blocked" | "done";
            startImmediately?: boolean;
            title: string;
        };
        SplitWorkCardResponse: {
            newCard: components["schemas"]["WorkCardResponse"];
            oldCard: components["schemas"]["WorkCardResponse"];
        };
        SubmitReviewInput: {
...
export interface operations {
    ...
    dispatchWorkboard: {
        ...
        responses: {
            ...
            202: {
                ...
                content: {
                    "application/json": components["schemas"]["ControllersDispatchWorkboardResponse"];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    nudgeWorkCard: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["NudgeWorkCardRequest"];
            };
        };
        responses: {
            /** @description OK */
    ...
    retargetWorkCard: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["RetargetWorkCardRequest"];
            };
        };
        responses: {
            /** @description OK */
    ...
    splitWorkCard: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["SplitWorkCardRequest"];
            };
        };
        responses: {
            /** @description OK */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["SplitWorkCardResponse"];
                };
            };
            /** @description Bad Request */
            400: {
