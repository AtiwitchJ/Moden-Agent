...
func workboardOperations() []operation {
	return []operation{
		...
		},
		{
			...
			reqBody:    controllers.UpdateWorkboardAutonomousRequest{},
			resps: []respUnit{
				{http.StatusOK, controllers.WorkboardAutonomousResponse{}},
				{http.StatusBadRequest, envelope.APIError{}},
				{http.StatusNotFound, envelope.APIError{}},
		...
		{
			method: http.MethodPost, path: "/api/v1/workboard/cards/{cardId}/nudge", id: "nudgeWorkCard", tag: "workboard",
			summary:    "Send a nudge message to a running card's linked worker session",
			pathParams: []any{controllers.WorkCardIDParam{}},
			reqBody:    controllers.NudgeWorkCardRequest{},
			resps: []respUnit{
				{http.StatusOK, controllers.WorkCardResponse{}},
				{http.StatusBadRequest, envelope.APIError{}},
				{http.StatusNotFound, envelope.APIError{}},
		...
		{
			method: http.MethodPost, path: "/api/v1/workboard/cards/{cardId}/retarget", id: "retargetWorkCard", tag: "workboard",
			summary:    "Retarget a running card's goal and hand off to Hermes or respawn the worker",
			pathParams: []any{controllers.WorkCardIDParam{}},
			reqBody:    controllers.RetargetWorkCardRequest{},
			resps: []respUnit{
				{http.StatusOK, controllers.WorkCardResponse{}},
				{http.StatusBadRequest, envelope.APIError{}},
				{http.StatusNotFound, envelope.APIError{}},
		...
		{
			method: http.MethodPost, path: "/api/v1/workboard/cards/{cardId}/split", id: "splitWorkCard", tag: "workboard",
			summary:    "Split a running card into a successor card and archive the original",
			pathParams: []any{controllers.WorkCardIDParam{}},
